...
//    var tapIconView: UIImageView?
    ...
    public convenience init(loadMode: Wto_ImageBrower.Mode, dataSource: [Any], tapIndex: Int = 0, originRect: CGRect = CGRect(x: UIScreen.main.bounds.size.width/2 - 0.5, y: UIScreen.main.bounds.size.height/2 - 0.5, width: 1, height: 1)) {
