...
class DatePickerController: ViewController {
    ...
    override func setupLayout() {
        ...
        textlabel.frame = CGRect(x: 15, y: kNavBarAndSafeHeight + 10, width: kScreenW - 30, height: 75)
        ...
        /// 渐变色
        let colorView = UIView.init(frame: CGRect(x: 50, y: kNavBarAndSafeHeight + 100, width: 100, height: 100))
