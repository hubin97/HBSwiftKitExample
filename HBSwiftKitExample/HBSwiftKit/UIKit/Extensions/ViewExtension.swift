...
extension ViewExtension {
    ...
    //MARK: 获取当前视图的层级最近控制器
    func nextVc(view:UIView) -> UIViewController? {
    ...
    //MARK: 指定矩形圆角
    /// 指定矩形某个/多个角为圆角, 默认全圆角
    func setRectCorner(rectCorner: UIRectCorner = .allCorners, radiiSize: CGFloat) {
    ...
    func setGradientColor(colors: [UIColor], direction: GradientDirection){
    ...
    /// 截图视图中的一部分
    func interceptRangeView(atFrame: CGRect?) -> UIImage? {
    ...
    @discardableResult
    func addBlur(style: UIBlurEffect.Style = .dark, alpha: CGFloat = 0.7) -> UIVisualEffectView {
    ...
    func addImageBlur(style: UIBlurEffect.Style = .dark, alpha: CGFloat = 0.7, img: UIImage?) {
    ...
    /// CIFilter  最终方案
    func addImageBlur2(style: UIBlurEffect.Style = .dark, alpha: CGFloat = 1, img: UIImage?) {
...
//    }
    ...
    func ciFilter(_ image: UIImage?) -> UIImage? {
